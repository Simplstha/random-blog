...
class BlogPost(db.Model):
    ...
    user_comment = relationship("Comment", back_populates="post_comment")
...
class Comment(UserMixin, db.Model):
    ...
    # parent = user and comment = child relation
    author_id = db.Column(db.Integer, db.ForeignKey('user_data.id'))
    comment_author = relationship("Users", back_populates="comment")
    # parent = blogpost and child = comment
    post_id = db.Column(db.Integer, db.ForeignKey("blog_posts.id"))
    post_comment = relationship("BlogPost", back_populates="user_comment")
    id = db.Column(db.Integer, primary_key=True)
